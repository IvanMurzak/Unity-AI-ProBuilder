...
using com.IvanMurzak.Unity.MCP.ProBuilder.Installer.SimpleJSON;

namespace com.IvanMurzak.Unity.MCP.ProBuilder.Installer.Tests
{
    public class VersionComparisonTests
    {
        const string TestManifestPath = "Temp/com.IvanMurzak.Unity.MCP.ProBuilder.Installer.Tests/test_manifest.json";
        const string PackageId = "com.ivanmurzak.unity.mcp.probuilder";
