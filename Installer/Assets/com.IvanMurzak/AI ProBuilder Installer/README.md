...
#### 3️⃣ Customize `Packages/com.ivanmurzak.unity.mcp.probuilder/package.json`
...
#### 4️⃣ Add files into `Packages/com.ivanmurzak.unity.mcp.probuilder` folder
...
- Copy the updated `README.md` to `Packages/com.ivanmurzak.unity.mcp.probuilder` as well.
