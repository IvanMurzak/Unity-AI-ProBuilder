...
<img width="100%" alt="Stats" src="https://github.com/IvanMurzak/Unity-AI-Tools-Template/raw/main/docs/img/ai-probuilder-glitch.gif"/>
...
- Replace `com.IvanMurzak.Unity.MCP.ProBuilder`, `AI ProBuilder`, etc. in all files.
