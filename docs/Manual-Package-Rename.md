...
#### 1️⃣ Customize `Packages/com.ivanmurzak.unity.mcp.probuilder/package.json`
...
<details>
  ...
  - 👉 **Delete** `Packages/com.ivanmurzak.unity.mcp.probuilder/Tests` folder
...
<details>
  ...
  - Update the files:
    - `Packages/com.ivanmurzak.unity.mcp.probuilder/Tests/Base/Package.Editor.Tests.asmdef`
    - `Packages/com.ivanmurzak.unity.mcp.probuilder/Tests/Base/Package.Tests.asmdef`
